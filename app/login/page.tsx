...
export default function LoginPage() {
  ...
  return (
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center justify-center w-full max-w-md">
        <div className="flex flex-col items-center gap-4">
          <Image
            ...
            priority
          />
          <h1 className="font-mono text-2xl font-semibold tracking-[-.01em] text-center">
            Welcome Back
          </h1>
        </div>
        ...
        <p className="font-mono text-sm text-center text-muted-foreground tracking-[-.01em]">
